...
import com.example.starstream.databinding.ItemGenreBinding
import com.example.starstream.util.MediaType

class GenreAdapter(private val mediaType: MediaType) : ListAdapter<Pair<Int, String>, GenreAdapter.ViewHolder>(
    DIFF_CALLBACK
) {
